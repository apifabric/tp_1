...
def expose_models(api, method_decorators = []): 
    ...
    api.expose_object(database.models.Employment, method_decorators= method_decorators)
    ...
    api.expose_object(database.models.OrderProductAssociation, method_decorators= method_decorators)
