...
resourcename="tp1"  # lower case, only
resourcegroup="tp1_rg"
...
# git clone https://github.com/apilogicserver/tp1.git
# cd tp1
...
az group create --name tp1_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group tp1_rg --sku S1 --is-linux
az container create --resource-group tp1_rg --name tp1 --image apilogicserver/tp1:latest --dns-name-label tp1 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//tp1.westus.azurecontainer.io:5656'
